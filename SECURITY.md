...
1. Open the [Security tab](https://github.com/raylsnetwork/rayls-sovereign-custody-light/security) of this repository.
...
- The affected component(s) (API, HSM/KMS key handling, wallet or transaction flows), version(s), and configuration.
...
This policy covers the `rayls-sovereign-custody-light` repository (the HSM custody API).
Vulnerabilities in other Rayls components should be reported against their respective repositories.
