...
1. Open the [Security tab](https://github.com/raylsnetwork/rayls-privacy-custody-light/security) of this repository.
...
This policy covers the `rayls-privacy-custody-light` repository (the HSM custody API).
